...
public class Settings extends PreferenceActivity {
    ...
    private void setupSimplePreferencesScreen() {
        ...
        // Add 'sending' preferences, and a corresponding header.
        PreferenceCategory fakeHeader = new PreferenceCategory(this);
        fakeHeader.setTitle(R.string.pref_header_sending);
        getPreferenceScreen().addPreference(fakeHeader);
        addPreferencesFromResource(R.xml.pref_sending);

        // Add 'receiving' preferences, and a corresponding header.
        fakeHeader = new PreferenceCategory(this);
        fakeHeader.setTitle(R.string.pref_header_receiving);
        getPreferenceScreen().addPreference(fakeHeader);
    ...
    /**
     * This fragment shows sending preferences only. It is used when the
    ...
    /**
     * This fragment shows receiving preferences only. It is used when the
     * activity is showing a two-pane settings UI.
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
